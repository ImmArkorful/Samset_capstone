...
const BannerV2 = ({ headers }) => {
  ...
  return (
    <div>
      {/* banner area start */}
      <Carousel {...settings} className="banner-area jarallax">
        {headers.map((headerImage) => (
          <div>
            <img src={`${headerImage}`} />
          </div>
        ))}
      ...
      <div
        className="banner-area jarallax new-banner"
        style={{
          //   position: "absolute",
          //   top: 0,
          //   left: 0,
              ...
              <div className="col-12">
                <div className="banner-inner">
                  ...
                  <div className="banner-btn-wrap">
                    <a
                      className="btn btn-yellow float-left mr-2"
                      href={data.btnurl}
                    >
                      {data.btntxt}
                    </a>
